        ...
        >
            <div
                ...
                style={{
                    ...
                    animation: 'scaleUpDown 3s infinite alternate',
                }}
            />
            <div
                className='absolute inset-0 -z-0 bg-no-repeat bg-contain'
                style={{
                    background: `url(${shapeHero2})`,
                    opacity: '0.5'
                }}
            />
            <div
                className='absolute left-0 bottom-0 bg-no-repeat bg-contain'
                style={{
            ...
            <motion.div
                ...
                className='flex flex-col p-5 md:p-14 lg:p-20 text-[#FFFFFF]'>
                <h1 className='text-6xl opacity-65  font-normal leading-snug '>Protecting Tenants with Tenacious and </h1>
                <h1 className='text-6xl font-semibold'>Affordable Defense</h1>
